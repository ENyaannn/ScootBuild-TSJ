...
const tsjApplyHome = (lang) => {
  ...
  tsjSetTexts([
    [".hero .eyebrow", lang === "ru" ? "Знакомство с TSJ" : "TSJ introduction"],
    [".hero h1", lang === "ru" ? "TSJscootbuild — это три друга с одним взглядом на скутеры." : "TSJscootbuild is three friends with one vision for scooters."],
    [".hero-text", lang === "ru" ? "Место про кастомную культуру скутеров, более чистые идеи и следующий этап наших сборок, стиля и направления." : "A place for custom scooter culture, cleaner ideas, and the next chapter of our builds, style, and direction."],
    [".hero-actions a:nth-child(1)", lang === "ru" ? "Кто мы" : "Who We Are"],
    [".hero-actions a:nth-child(2)", lang === "ru" ? "Связаться с TSJ" : "Contact TSJ"],
    [".hero-stats article:nth-child(1) span", lang === "ru" ? "Друзей в команде" : "Friends in the crew"],
    [".hero-stats article:nth-child(2) span", lang === "ru" ? "Общая идентичность" : "Shared identity"],
    [".hero-stats article:nth-child(3) span", lang === "ru" ? "Мышление проекта" : "Project mindset"],
    ...
    [".hero-badge-bottom", lang === "ru" ? "ДРУЖБА / СБОРКИ / ИДЕНТИЧНОСТЬ" : "FRIENDSHIP / BUILDS / IDENTITY"],
...
const tsjApplyAbout = (lang) => {
  ...
  tsjSetTexts([
    ...
    [".projects-hero h1", lang === "ru" ? "Три друга, одно направление и одна развивающаяся скутерная идентичность." : "Three friends, one direction, one evolving scooter identity."],
